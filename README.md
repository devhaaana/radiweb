...
| File                                                                                    | Description                                                        |
| :-------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| [radiweb-2.0.0.zip](https://github.com/devhaaana/radiweb/archive/refs/tags/v2.0.0.zip)       | A*ZIP* file containing the full source code of radiweb v2.0.0    |
| [radiweb-2.0.0.tar.gz](https://github.com/devhaaana/radiweb/archive/refs/tags/v2.0.0.tar.gz) | A*TAR.GZ* file containing the full source code of radiweb v2.0.0 |
